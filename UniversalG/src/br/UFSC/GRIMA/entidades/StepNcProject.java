...
import jsdai.SMachining_schema.ACutting_component;
import jsdai.SMachining_schema.AExecutable;
import jsdai.SMachining_schema.AMachining_operation;
import jsdai.SMachining_schema.AProperty_parameter;
import jsdai.SMachining_schema.ASlot_end_type;
import jsdai.SMachining_schema.AWorkpiece;
import jsdai.SMachining_schema.AWorkpiece_setup;
import jsdai.SMachining_schema.AWorkplan;
import jsdai.SMachining_schema.EAxis2_placement_3d;
import jsdai.SMachining_schema.EB_spline_curve_form;
import jsdai.SMachining_schema.EBall_endmill;
import jsdai.SMachining_schema.EBezier_curve;
import jsdai.SMachining_schema.EBlock;
import jsdai.SMachining_schema.EBoring;
import jsdai.SMachining_schema.EBoring_tool;
import jsdai.SMachining_schema.EBottom_and_side_finish_milling;
import jsdai.SMachining_schema.EBottom_and_side_rough_milling;
import jsdai.SMachining_schema.EBullnose_endmill;
import jsdai.SMachining_schema.ECartesian_point;
import jsdai.SMachining_schema.ECenter_drill;
import jsdai.SMachining_schema.ECenter_drilling;
import jsdai.SMachining_schema.EClosed_pocket;
import jsdai.SMachining_schema.EClosed_profile;
import jsdai.SMachining_schema.EConical_hole_bottom;
import jsdai.SMachining_schema.EContour_parallel;
import jsdai.SMachining_schema.ECutmode_type;
import jsdai.SMachining_schema.ECutting_component;
import jsdai.SMachining_schema.EDiameter_taper;
import jsdai.SMachining_schema.EDirection;
import jsdai.SMachining_schema.EDrilling;
import jsdai.SMachining_schema.EDrilling_type_strategy;
import jsdai.SMachining_schema.EEndmill;
import jsdai.SMachining_schema.EExecutable;
import jsdai.SMachining_schema.EFacemill;
import jsdai.SMachining_schema.EFlat_hole_bottom;
import jsdai.SMachining_schema.EFlat_with_radius_hole_bottom;
import jsdai.SMachining_schema.EFreeform_operation;
import jsdai.SMachining_schema.EGeneral_profile;
import jsdai.SMachining_schema.EHand;
import jsdai.SMachining_schema.EHole_bottom_condition;
...
import jsdai.SMachining_schema.EManufacturing_feature;
import jsdai.SMachining_schema.EMaterial;
import jsdai.SMachining_schema.EMilling_cutting_tool;
import jsdai.SMachining_schema.EMilling_machine_functions;
import jsdai.SMachining_schema.EMilling_technology;
import jsdai.SMachining_schema.ENumeric_parameter;
import jsdai.SMachining_schema.EOpen_slot_end_type;
import jsdai.SMachining_schema.EPartial_circular_profile;
import jsdai.SMachining_schema.EPerson;
import jsdai.SMachining_schema.EPerson_and_address;
import jsdai.SMachining_schema.EPlanar_pocket_bottom_condition;
import jsdai.SMachining_schema.EPlane;
import jsdai.SMachining_schema.EPlunge_toolaxis;
import jsdai.SMachining_schema.EPlus_minus_value;
import jsdai.SMachining_schema.EPocket_bottom_condition;
import jsdai.SMachining_schema.EProject;
import jsdai.SMachining_schema.EReamer;
import jsdai.SMachining_schema.EReaming;
import jsdai.SMachining_schema.ERectangular_closed_profile;
import jsdai.SMachining_schema.ERot_direction;
import jsdai.SMachining_schema.ERound_hole;
import jsdai.SMachining_schema.ERounded_u_profile;
import jsdai.SMachining_schema.ESetup;
...
import jsdai.SMachining_schema.ETool_dimension;
import jsdai.SMachining_schema.ETool_reference_point;
import jsdai.SMachining_schema.ETwist_drill;
import jsdai.SMachining_schema.EVee_profile;
import jsdai.SMachining_schema.EWorkpiece;
import jsdai.SMachining_schema.EWorkpiece_setup;
...
//									EMachining_operation eMachining_operation = this.operations.getCurrentMember(iterator);
	...
	private void setProject(String id, double globalTolerance) throws SdaiException
	{
		...
		aWorkpiece.addUnordered(createWorkpiece("workpiece", globalTolerance, workpieceLength, workpiecewidth, workpieceHight, clampingPoints));
	}
...
//	}
	...
	private EMilling_cutting_tool createTwistDrillTool(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = this.createToolDimension(broca);
...
//		eMaterial.setMaterial_identifier(null, broca.getMaterial());
	...
	private EMilling_cutting_tool createReamerTool(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = createToolDimension(reamer);
	...
	private EMilling_cutting_tool createBoringTool(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = this.createToolDimension(borer);
	...
	private EMilling_cutting_tool createCenterDrillTool(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = this.createToolDimension(centerDrill);
	...
	private EMilling_cutting_tool createFaceMill(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = createToolDimension(faceMill);
	...
	private EMilling_cutting_tool createEndMill(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = createToolDimension(endMill);
	...
	private EMilling_cutting_tool createBallEndMillTool(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = this.createToolDimension(ballEndMill);
	...
	private EMilling_cutting_tool createBullNoseEndMill(Workingstep ws) throws SdaiException
	{
		...
		ETool_dimension eTool_dimension = this.createToolDimension(bullnoseEndMill);
	...
	private EMachining_tool createMachiningTool(String id, Feature featureType, double offsetLength, int finishingType) throws SdaiException
	{
		...
		if(finishingType == Workingstep.DESBASTE)
		{
			if(featureType.getClass() == Ranhura.class ||featureType.getClass() == Degrau.class || featureType.getClass() == Cavidade.class)
			{
				...
				ETool_dimension eTool_dimension = createToolDimension(toolDiameter, toolTipAngle, 0, toolEdgeCuttingLength, 0);
				eFacemill.setDimension(null, eTool_dimension);
	...
	private ETool_dimension createToolDimension(double diameter, double toolTipHalfAngle,  double toolCircunferenceAngle, double cuttingEdgeLength, double edgeRadius) throws SdaiException
	{
		ETool_dimension eTool_dimension = (ETool_dimension)model.createEntityInstance(ETool_dimension.class);
		eTool_dimension.setDiameter(null, diameter);
		eTool_dimension.setTool_top_angle(null, toolTipHalfAngle);
	...
	private ETool_dimension createToolDimension(Ferramenta ferramenta) throws SdaiException
	{
		ETool_dimension eTool_dimension = (ETool_dimension)this.model.createEntityInstance(ETool_dimension.class);
		eTool_dimension.setDiameter(null, ferramenta.getDiametroFerramenta());
		eTool_dimension.setTool_top_angle(null, ferramenta.getToolTipHalfAngle() * Math.PI / 180);
