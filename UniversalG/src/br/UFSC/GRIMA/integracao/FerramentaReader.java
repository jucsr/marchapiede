...
public class FerramentaReader {
	...
	public static Ferramenta getFerramenta(
		...
		if (eTool_body.isKindOf(ECenter_drill.class)) {
			...
			ETool_dimension dimension = center_drill.getDimension(null);
			...
			double tipAngle = dimension.getTool_top_angle(null)*180/Math.PI;
			...
			ETool_dimension dimension = twist_drill.getDimension(null);
			...
			ETool_dimension dimension = facemill.getDimension(null);
			...
			ETool_dimension dimension = endmill.getDimension(null);
			...
			ETool_dimension dimension = ball_endmill.getDimension(null);
			...
			ETool_dimension dimension = bullnose_endmill.getDimension(null);
			...
			ETool_dimension dimension = eReamer.getDimension(null);
			...
			ETool_dimension dimension = boring_tool.getDimension(null);
