...
public class JanelaCodigoStep extends JanelaCodigoSTEP_view implements
	...
	public JanelaCodigoStep(StepNcProject stepNcProject) {
		...
		this.menuItem13.addActionListener(this);
...
//		System.out.println(gCode);
	...
	private void generateGenericGCode() 
	{
		GenerateGenericGCode generate = new GenerateGenericGCode(workingsteps, projeto);
		String gCode = generate.GenerateGCodeString();
		JanelaCodigoG jcg = new JanelaCodigoG();
		jcg.textPane1.setText(gCode);
		jcg.setVisible(true);
	}
...
//			lerProjeto();
		...
		{
			this.find();
		} else if(origem == this.menuItem13)
		{
			this.generateGenericGCode();
		}
	}
