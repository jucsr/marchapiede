	...
	private void initComponents() {
		...
		//======== menuBar1 ========
		{
			...
			//======== menu3 ========
			{
				...
				//---- menuItem13 ----
				menuItem13.setText("Generic G Code");
				menuItem13.setIcon(new ImageIcon(getClass().getResource("/images/iconeGCode.png")));
				menuItem13.setToolTipText("P\u00f3s processar para Siemens 840Di");
