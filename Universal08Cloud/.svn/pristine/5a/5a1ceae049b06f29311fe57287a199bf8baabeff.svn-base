...
public class GenerateGenericGCode {
	...
	public GenerateGenericGCode(Vector <Vector> Workingsteps, Projeto projeto){
					...
					if(wsTmp.getFeature().getClass().equals(GeneralClosedPocket.class) && (wsTmp.getFerramenta().getClass().equals(FaceMill.class) || wsTmp.getFerramenta().getClass().equals(EndMill.class))){
						...
						if(wsTmp.getOperation().getClass() == BottomAndSideRoughMilling.class){
							...
							if(wsTmp.getOperation().getMachiningStrategy().getClass() == ContourParallel.class) /*=====================***/
							{
								...
								System.out.println("CONTOUR________");
								MovimentacaoGeneralClosedPocket genClosed= new MovimentacaoGeneralClosedPocket(wsTmp);
								ArrayList<Path> paths = genClosed.getDesbasteContourParallel();
								GCode += GenerateContourParallelGenericGCode.transformPathToGCode(paths);
							}
