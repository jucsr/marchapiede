 ...
 * @author wwinder
 */
public class VisualizerWindow extends JDialog implements ControllerListener, WindowListener 
{
...
//    private static String TITLE = Localization.getString("visualizer.title");  // window's title
    ...
    private List<String> gcodeFile = null;
...
//        frame.setTitle("ST-Path");
//        frame.pack();
//        frame.setVisible(true);
        this.getContentPane().add(canvas);
        this.addWindowListener(this);
        this.setTitle("ST-Path Viewer");
        this.pack();
    ...
    public void setGcodeFile( List<String> file) {
        this.gcodeFile = file;
