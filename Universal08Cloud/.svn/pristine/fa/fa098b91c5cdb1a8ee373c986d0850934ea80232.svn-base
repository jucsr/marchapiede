...
public abstract class MachiningOperation implements Serializable
{
	...
	private MachiningStrategy machiningStrategy;
	
	public MachiningStrategy getMachiningStrategy() 
	{
		return machiningStrategy;
	}

	public void setMachiningStrategy(MachiningStrategy machiningStrategy) 
	{
