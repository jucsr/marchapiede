					...
					//======== panel13 ========
					{
						...
						//======== panel15 ========
						{
							...
							//======== layeredPane4 ========
							{
								...
								//---- label2 ----
								label2.setIcon(new ImageIcon(getClass().getResource("/images/trochoidalAndContourParallelStrategie.png")));
								layeredPane4.add(label2, JLayeredPane.DEFAULT_LAYER);
								label2.setBounds(5, 5, 320, 330);

								//---- spinner16 ----
								spinner16.setModel(new SpinnerNumberModel(0.5, 0.0, 10.0, 0.1));
								layeredPane4.add(spinner16, JLayeredPane.DEFAULT_LAYER);
								spinner16.setBounds(new Rectangle(new Point(195, 185), spinner16.getPreferredSize()));
							}
