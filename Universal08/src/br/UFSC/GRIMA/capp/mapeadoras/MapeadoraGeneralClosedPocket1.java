...
//					g2d.fill(shape);
		...
		JLabel label3 =  new JLabel("Area Relativa = " + GeometricOperations.roundNumber(areaRelativa, 3));
		JLabel label4 =  new JLabel("Tempo = " + GeometricOperations.roundNumber(time, 3));
		...
		panelTmp.add(BorderLayout.CENTER, label4);
